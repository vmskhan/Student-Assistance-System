...
=======
                  <NavLink activeClassName="is-active" className="btn btn-outline-primary border-0 fw-normal text-decoration-italic" aria-current="page" to="/" exact><b>Home</b></NavLink>
>>>>>>> Stashed changes
                </li>
...
=======
                  <NavLink activeClassName="is-active" className="btn btn-outline-primary border-0 fw-normal text-decoration-italic" to="/FacultyRegister"><b>Faculty signup</b></NavLink>
                </li>
              </ul>
              <div className="d-flex align-items-center" >
