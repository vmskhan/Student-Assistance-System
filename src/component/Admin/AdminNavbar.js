          ...
          <div className="container-fluid">
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li><NavLink activeClassName="is-active" className="btn btn-outline-light border-0 fw-bold fst-italic" to="/admin/InstitutionInfo">Institutional Data</NavLink></li>
                ...
                <li><NavLink activeClassName="is-active" className="btn btn-outline-light border-0 fw-bold fst-italic" to="/admin/Timetables">Time Table</NavLink></li>
              </ul>
